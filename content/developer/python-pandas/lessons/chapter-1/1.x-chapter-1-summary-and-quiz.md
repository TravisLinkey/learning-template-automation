...
These skills directly support [Project 1 — Backtesting Engine](/quant-backtester/lessons/0.1): load data (1.4), store in a DataFrame with DatetimeIndex (1.1, 1.3), add indicators and signals (1.1, 1.2), and iterate without look-ahead (1.2).
