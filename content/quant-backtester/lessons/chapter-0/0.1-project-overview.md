...
| Lesson | Description |
|--------|-------------|
| **0.1 — Project overview** (this page) | Objective, focus areas, steps, prerequisites, and hints |
| **[0.2 — Project guide](/quant-backtester/lessons/0.2)** | Step-by-step implementation guide with hints and collapsible solutions for each step |

Work through the overview first, then use the [Project guide](/quant-backtester/lessons/0.2) as you build the engine.
...
- **P&L and slippage** — Start with close-to-close returns and no slippage. Later you can add a simple slippage model (e.g., fixed bps per trade). See [Project guide — Simulate trades](/quant-backtester/lessons/0.2#5-simulate-trades-positions-p-l-equity-curve) for implementation.
