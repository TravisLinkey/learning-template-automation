...
A **sample space**, denoted by $\Omega$ (omega), is the set of all possible outcomes of a random experiment.
...
An **event** is a subset of the sample space. An event occurs if the outcome of the experiment is in that subset.
