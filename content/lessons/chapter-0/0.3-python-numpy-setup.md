...
1. **NumPy**: Numerical computing, arrays, and basic probability functions
2. **SciPy**: Advanced statistical functions and distributions
3. **Matplotlib**: Visualization and plotting
4. **pandas**: Data manipulation (for time series work)
5. **Jupyter**: Interactive notebooks (recommended)
