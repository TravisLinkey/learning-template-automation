...
|-------|-----------------|----------------|
| **Project 1 — Backtester** | Data pipeline, backtest evaluation | [Project 1: Backtesting Engine](/quant-backtester/lessons/0.1) |
| **Project 2 — Paper Bot** | Execution of ML signals | [Project 2: Paper Trading Bot](/quant-paper-bot/lessons/0.1) |
...
- **Backtest vs. live** — Backtest the ML strategy through your Project 1 engine before going live in paper. Compare ML strategy metrics to your earlier non-ML backtest. [Project 1](/quant-backtester/lessons/0.1).
