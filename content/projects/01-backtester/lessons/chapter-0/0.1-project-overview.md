...
| **[0.2 — Project guide](0.2-project-guide)** | Step-by-step implementation guide with hints and collapsible solutions for each step |

Work through the overview first, then use the [Project guide](0.2-project-guide) as you build the engine.
...
- **P&L and slippage** — Start with close-to-close returns and no slippage. Later you can add a simple slippage model (e.g., fixed bps per trade). See [Project guide — Simulate trades](0.2-project-guide#5-simulate-trades-positions-p-l-equity-curve) for implementation.
