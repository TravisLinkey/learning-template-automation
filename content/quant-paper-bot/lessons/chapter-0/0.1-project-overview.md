...
|-------|-----------------|----------------|
| **Project 1 — Backtester** | Signal logic and performance mindset | [Project 1: Backtesting Engine](/quant-backtester/lessons/0.1) |
...
Next step: [Project 3 — Machine Learning Strategy](/quant-ml-trader/lessons/0.1), where you’ll add predictive models and feed their signals into this bot.
